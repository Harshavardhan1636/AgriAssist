...
For full functionality, Firebase needs to be configured. See [FIREBASE_SETUP.md](FIREBASE_SETUP.md) for detailed instructions.

Demo mode is available without Firebase configuration:
